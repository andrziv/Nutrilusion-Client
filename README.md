...
![Timeline screenshot](https://github.com/andrziv/Nutritool-Client/blob/main/readmeImages/appLogNewItemEmpty.png "Timeline screenshot with multiple logged items.")
...
:-------------------------:|:-------------------------:
![Timeline screenshot](https://github.com/andrziv/Nutritool-Client/blob/main/readmeImages/appRecipeListFull.png "Timeline screenshot with multiple logged items.")  |  ![Timeline screenshot](https://github.com/andrziv/Nutritool-Client/blob/main/readmeImages/appFoodItemDetails.png "Timeline screenshot with multiple logged items.")
...
Ingredient             |  Nutrient
:-------------------------:|:-------------------------:
![](https://github.com/andrziv/Nutritool-Client/blob/main/readmeImages/appIngredientEdit.png)  |  ![](https://github.com/andrziv/Nutritool-Client/blob/main/readmeImages/appNutrientEdit.png)
...
![](https://github.com/andrziv/Nutritool-Client/blob/main/readmeImages/appLogNewItem.png)
...
![](https://github.com/andrziv/Nutritool-Client/blob/main/readmeImages/appFullHomescreenDarkModified.png)
