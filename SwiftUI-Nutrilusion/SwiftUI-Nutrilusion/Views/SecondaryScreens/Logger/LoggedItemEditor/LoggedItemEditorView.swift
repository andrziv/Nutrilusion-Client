...
struct LoggedItemEditorView: View {
    @ObservedObject private var viewModel: NutrilusionFoodViewModel
    ...
    init(viewModel: NutrilusionFoodViewModel,
...
#Preview {
    LoggedItemEditorView(viewModel: NutrilusionFoodViewModel(repository: MockFoodRepository()), date: Date()) {
