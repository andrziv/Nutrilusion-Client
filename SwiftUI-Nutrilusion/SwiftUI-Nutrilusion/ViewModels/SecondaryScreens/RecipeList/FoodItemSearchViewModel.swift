...
class FoodItemSearchViewModel: ObservableObject {
    ...
    @ObservedObject private var foodViewModel: NutrilusionFoodViewModel
    private let searchDelayTime: Int
    private let resultLimit: Int
    private var cancellables = Set<AnyCancellable>()
    private var currentSearchTask: Task<Void, Never>?

    init(foodViewModel: NutrilusionFoodViewModel, searchDelayTime: Int = 300, resultLimit: Int = 100) {
